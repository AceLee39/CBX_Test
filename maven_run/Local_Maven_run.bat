echo off
copy /y ".\settings\jetty9env_local.xml" "..\..\CBX_Business\settings\jetty9env.xml"
copy /y ".\settings\jetty-mvn-debug.cmd" "..\..\CBX_Business\jetty-debug.cmd"
rem copy /y ".\settings\log4j.xml" "..\..\CBX_Business\src\main\resources"
