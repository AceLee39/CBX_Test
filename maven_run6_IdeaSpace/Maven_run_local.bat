echo off
copy /y ".\settings\local_jetty9env.xml" "C:\Users\ace.li\CBX\IdeaSpace\CBX_Business\settings\jetty9env.xml"
...
del  /q /a /f /s "C:\Users\ace.li\CBX\IdeaSpace\CBX_Business\logs"

cd "C:\Users\ace.li\CBX\IdeaSpace\CBX_Business"
jetty-debug.cmd